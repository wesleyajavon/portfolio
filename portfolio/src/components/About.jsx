...
export default function About() {
    return (
        ...
        >
            <section id="about" className="w-full px-4 sm:px-6 lg:px-16 py-12 bg-gradient-to-t from-gray-800 to-gray-500">
                <div className="max-w-5xl mx-auto flex flex-col text-center sm:text-left">
